...
class _TaxAccountPayableFormState extends State<TaxAccountPayableForm> {
  ...
  Widget build(BuildContext context) {
    ...
    final errorMessage = widget.showValidationMessages
                        ...
                        Row(
                          ...
                          children: [
                            ...
                            IconButton(
                              ...
                              onPressed: () => widget.formStore.removeTaxLine(index),
                            ),
                          ],
                        )
                      ],
  ...
  Future<AccountsPayableTaxLine?> _showTaxDialog(
    ...
    String amountText = initial != null && initial.amount > 0
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    Input(
                      ...
                      onValidator: (value) {
                        final amount =
                            CurrencyFormatter.cleanCurrency(value ?? '0');
                        if (amount <= 0) {
                    ...
                    Dropdown(
                      ...
                      initialValue: status == AccountsPayableTaxStatus.substitution
                          ? 'Substituição tributária'
                          : 'Tributada',
                      onChanged: (value) {
