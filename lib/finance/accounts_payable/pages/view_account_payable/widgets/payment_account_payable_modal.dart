...
class _PaymentAccountPayableModal extends State<PaymentAccountPayableModal> {
  ...
  Widget _buildDropdownCostCenter(CostCenterListStore costCenterStore,
      PaymentAccountPayableStore formStore) {
    return Dropdown(
      label: "Centro de custo",
      items: costCenterStore.state.costCenters.map((e) => e.name).toList(),
      onChanged: (value) {
        final selectedCostCenter = costCenterStore.state.costCenters
  ...
  Widget _buildDropdownAvailabilityAccounts(
    ...
    return Dropdown(
      ...
      items: availabilityStore.state.availabilityAccounts
