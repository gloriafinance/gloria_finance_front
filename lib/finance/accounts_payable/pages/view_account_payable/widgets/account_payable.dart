  ...
  Widget _getProvider(
    ...
    return Padding(
      ...
      child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
        ...
        const SizedBox(height: 16),
        buildDetailRow(
            isMobile, 'Nome', widget.account.supplier?.name ?? 'N/A'),
        buildDetailRow(
            isMobile, 'CNPJ/CPF', widget.account.supplier?.dni ?? 'N/A'),
        buildDetailRow(
            isMobile, 'Phone', widget.account.supplier?.phone ?? 'N/A'),
        buildDetailRow(
            isMobile, 'E-mail', widget.account.supplier?.email ?? 'N/A'),
        buildDetailRow(isMobile, 'Tipo de fornecedor',
