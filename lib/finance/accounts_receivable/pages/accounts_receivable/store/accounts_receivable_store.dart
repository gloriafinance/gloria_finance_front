import 'package:church_finance_bk/finance/accounts_receivable/pages/accounts_receivable/state/accounts_receivable_paginate_state.dart';
...
class AccountsReceivableStore extends ChangeNotifier {
  ...
  void searchAccountsReceivable() {
    ...
    service.listAccountsReceivable(state.filter).then((value) {
