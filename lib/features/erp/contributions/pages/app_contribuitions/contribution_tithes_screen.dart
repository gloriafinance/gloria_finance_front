...
class _ContributionTithesScreenState extends State<ContributionTithesScreen> {
  ...
  Widget build(BuildContext context) {
    ...
    if (conceptStore.state.financialConcepts.isNotEmpty) {
      final titheConcept = conceptStore.state.financialConcepts.firstWhere(
        (e) => e.name.startsWith("Dízimo"),
      );
        ...
        children: [
          ...
          isMobile(context)
              ...
              : Align(
                ...
                child: SizedBox(width: 300, child: _btnSave(formTitheStore)),
              ),
        ],
      ),
    );
